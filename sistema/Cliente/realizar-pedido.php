		...
		<div class="widget">	
			<div class="m-b-lg nav-tabs-horizontal">
				...
				<div class="col-md-2">
						...
						<button id="btnFinalizar" type="button" <?php if (isset($_SESSION['id_lista']) && $_SESSION['id_lista'] == 0){ echo 'style="display:none;"'; }?> class="btn rounded mw-md btn-primary " form="formCadastro" value="Submit">Finalizar Pedido</button>
				</div>
	...
	$('.btnAdicionar').click(function() {
		...
		$.ajax({
			...
			success: function(msg) {
				alert('Produto Adicionado/Alterado');
				$("#btnFinalizar").show();
			}               
		});
	});
