...
<?php include_once "headerMaster.php";?>
          <h5 class="page-title hidden-menubar-top hidden-float">Consultar Mercado</h5>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <table id="responsive-datatable" data-plugin="DataTable" data-options="{
                            ...
                            <thead>
                                <tr role="row">
									<th class="sorting_asc" tabindex="0" aria-controls="responsive-datatable" rowspan="1" colspan="1" style="width: 125px;" aria-label="nome: activate to sort column descending" aria-sort="ascending">Cod. Mercado</th>
                            ...
                            <tfoot>
                                <tr>
									<th rowspan="1" colspan="1">Cod. Mercado</th>
...
$('#responsive-datatable tbody').on( 'click', 'tr', function () {
		...
		<?php $_SESSION['urlCaminho'] = "consultaMercado.php"; ?>
